...
void GateBootstrapping(TLWE<lvl2param> &res, const TLWE<lvl2param> &tlwe,
                       const EvalKey &ek)
{
    TLWE<lvl0param> tlwelvl0;
    IdentityKeySwitch<lvl20param>(tlwelvl0, tlwe, *ek.iksklvl20);
    GateBootstrappingTLWE2TLWEFFT<lvl02param>(res, tlwelvl0, *ek.bkfftlvl02,
                                              μpolygen<lvl2param, μ>());
}
